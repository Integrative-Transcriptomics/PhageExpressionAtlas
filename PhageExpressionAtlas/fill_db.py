...
with app.app_context():
    addFullDataset(phageName='T4 phage', phageDes = 'Bacteriophage T4', phageID = 'NC_000866.4', phageType = 'virulent',
               ...
               rnaSeqPath = '/data/Wolfram-Schauerte_2022/Wolfram-Schauerte_fractional_expression.tsv', norm = 'fractional',
               ...
               phageGenomePath = '/data/Wolfram-Schauerte_2022/T4Genome.gff3', phageGenomeName = 'T4 phage genome',
               hostGenomePath = '/data/Wolfram-Schauerte_2022/EcoliGenome.gff3', hostGenomeName = 'E. coli genome')

# Add more datasets with different normalizations of Wolfram-Schauerte_2022
with app.app_context():
    addSingleDataset(rnaSeqPath = '/data/Wolfram-Schauerte_2022/Wolfram-Schauerte_full_TPM.tsv',
    ...
    addSingleDataset(rnaSeqPath = '/data/Wolfram-Schauerte_2022/Wolfram-Schauerte_TPM_means.tsv',
                     norm = 'TPM_means', name = 'Wolfram-Schauerte_2022', year = 2022, journal = 'Viruses', description = description,
                     firstauthor = 'Wolfram-Schauerte', pubmedID = 36423111, host_id=1, phage_id=1)
    addSingleDataset(rnaSeqPath = '/data/Wolfram-Schauerte_2022/Wolfram-Schauerte_TPM_std.tsv',
...
with app.app_context():
    addSingleDataset(rnaSeqPath = '/data/Guegler_2021/Guegler_fractional_expression.tsv',
    ...
    addSingleDataset(rnaSeqPath = '/data/Guegler_2021/Guegler_full_TPM.tsv',
                     norm = 'TPM', name = 'Guegler_2021', year = 2021, journal = 'Molecular Cell', description = description,
                     firstauthor = 'Guegler', pubmedID = 33838104, host_id=1, phage_id=1)
    addSingleDataset(rnaSeqPath = '/data/Guegler_2021/Guegler_TPM_means.tsv',
                     norm = 'TPM_means', name = 'Guegler_2021', year = 2021, journal = 'Molecular Cell', description = description,
                     firstauthor = 'Guegler', pubmedID = 33838104, host_id=1, phage_id=1)
    addSingleDataset(rnaSeqPath = '/data/Guegler_2021/Guegler_TPM_std.tsv',
...
with app.app_context():
    addFullDataset(phageName='Kayvirus phage K', phageDes = 'Staphylococcus virus K', phageID = 'NC_005880.2', phageType = 'virulent',
               ...
               rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_Newman_fractional_expression.tsv', norm = 'fractional',
               ...
               phageGenomePath = '/data/Finstrlova_2022/NC_005880-2.gff3', phageGenomeName = 'K virus genome',
               hostGenomePath = '/data/Finstrlova_2022/AP009351-1.gff3', hostGenomeName = 'S. aureus Newman genome')

with app.app_context():
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_Newman_full_TPM.tsv', norm = 'TPM',
    ...
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_Newman_TPM_means.tsv', norm = 'TPM_means',
               name = 'Finstrlova_2022_Newman', year = 2022, journal = 'Microbiology Spectrum', firstauthor = 'Finstrlova', pubmedID = 3545752, description = description, host_id=2, phage_id=2)
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_Newman_TPM_std.tsv', norm = 'TPM_std',
               name = 'Finstrlova_2022_Newman', year = 2022, journal = 'Microbiology Spectrum', firstauthor = 'Finstrlova', pubmedID = 3545752, description = description, host_id=2, phage_id=2)
...
with app.app_context():
    hostgff = pd.read_csv('/data/Finstrlova_2022/GCA_021739435-1.gff', sep='\t', comment = '#')
    hostgenome = pickle.dumps(hostgff)
...
with app.app_context():
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_SH1000_fractional_expression.tsv', norm = 'fractional',
    ...
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_SH1000_full_TPM.tsv', norm = 'TPM',
               name = 'Finstrlova_2022_SH1000', year = 2022, journal = 'Microbiology Spectrum', firstauthor = 'Finstrlova', pubmedID = 3545752, description = description, host_id=3, phage_id=2)
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_SH1000_TPM_means.tsv', norm = 'TPM_means',
               name = 'Finstrlova_2022_SH1000', year = 2022, journal = 'Microbiology Spectrum', firstauthor = 'Finstrlova', pubmedID = 3545752, description = description, host_id=3, phage_id=2)
    addSingleDataset(rnaSeqPath = '/data/Finstrlova_2022/Finstrlova_SH1000_TPM_std.tsv', norm = 'TPM_std',
               name = 'Finstrlova_2022_SH1000', year = 2022, journal = 'Microbiology Spectrum', firstauthor = 'Finstrlova', pubmedID = 3545752, description = description, host_id=3, phage_id=2)
...
with app.app_context():
    addFullDataset(phageName='vB_SauM-515A1 kayvirus', phageDes = 'Staphylococcus phsge vB_SauM-515A1', phageID = 'MN047438.1', phageType = 'virulent',
               ...
               rnaSeqPath = '/data/Kuptsov_2022/Kuptsov_fractional_expression.tsv', norm = 'fractional',
               name = 'Kuptsov_2022', year = 2022, journal = 'Viruses', firstauthor = 'Kuptsov', pubmedID = 35336974, description = description,
               phageGenomePath = '/data/Kuptsov_2022/MN047438-1.gff3', phageGenomeName = 'vB_SauM-515A1 virus genome',
               hostGenomePath = '/data/Kuptsov_2022/GCA_022352045-1.gff', hostGenomeName = 'S. aureus SA515 genome')

with app.app_context():
    addSingleDataset(rnaSeqPath = '/data/Kuptsov_2022/Kuptsov_full_TPM.tsv', norm = 'TPM',
    ...
    addSingleDataset(rnaSeqPath = '/data/Kuptsov_2022/Kuptsov_TPM_means.tsv', norm = 'TPM_means',
               name = 'Kuptsov_2022', year = 2022, journal = 'Viruses', firstauthor = 'Kuptsov', pubmedID = 35336974, description = description, host_id=4, phage_id=3)
    addSingleDataset(rnaSeqPath = '/data/Kuptsov_2022/Kuptsov_TPM_std.tsv', norm = 'TPM_std',
               name = 'Kuptsov_2022', year = 2022, journal = 'Viruses', firstauthor = 'Kuptsov', pubmedID = 35336974, description = description, host_id=4, phage_id=3)
...
with app.app_context():
    addFullDataset(phageName='PhiR1-37', phageDes = 'Yersinia phage phiR1-37', phageID = 'AJ972879.2', phageType = 'virulent',
               ...
               rnaSeqPath = '/data/Leskinen_2016/Leskinen_fractional_expression.tsv', norm = 'fractional',
               name = 'Leskinen_2016', year = 2016, journal = 'Viruses', firstauthor = 'Leskinen', pubmedID = 27110815, description = description,
               phageGenomePath = '/data/Leskinen_2016/AJ972879-2.gff3', phageGenomeName = 'PhiR1-37 virus genome',
               hostGenomePath = '/data/Leskinen_2016/NC_017564-1.gff3', hostGenomeName = 'Y. enterocolitica O:3 genome')

with app.app_context():
    addSingleDataset(rnaSeqPath = '/data/Leskinen_2016/Leskinen_full_TPM.tsv', norm = 'TPM',
    ...
    addSingleDataset(rnaSeqPath = '/data/Leskinen_2016/Leskinen_TPM_means.tsv', norm = 'TPM_means',
               name = 'Leskinen_2016', year = 2016, journal = 'Viruses', firstauthor = 'Leskinen', pubmedID = 27110815, description = description, host_id=5, phage_id=4)
    addSingleDataset(rnaSeqPath = '/data/Leskinen_2016/Leskinen_TPM_std.tsv', norm = 'TPM_std',
               name = 'Leskinen_2016', year = 2016, journal = 'Viruses', firstauthor = 'Leskinen', pubmedID = 27110815, description = description, host_id=5, phage_id=4)