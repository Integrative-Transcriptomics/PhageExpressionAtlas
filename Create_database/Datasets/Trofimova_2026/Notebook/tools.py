...
def txPCA(df):
    ...
    X['TimePoint'] = df.columns.tolist()
    ax = sns.scatterplot(x = "Dim1", y = "Dim2", data = X, hue = "TimePoint")
...
def getMeanSD(df):
    ...
    for base in sampleBase:
        ...
        base_name = base.split('_')[0]  # Strip '_xxx' from the base
